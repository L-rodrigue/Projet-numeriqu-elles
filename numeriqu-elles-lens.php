...
<h1>Numeriqu'<span>Elles </span>Lens</h1>
    ...
    <div class='container'>
            ...
            <p> l’atelier <br>
                Jeux des talents <br>
                découverte des métiers du <br>
                numérique présentation <br>
                du fonctionnement de <br>
                l'intelligence artificille</p>
        </div>
        <div class='container'>
            <a href="https://www.norsys.fr/"><img src="les_photos_drive/logo_fondation_norsys.png" alt="logo"></a>
            <p> l’atelier <br>
                Casser les stéréotypes <br>
                des métiers de l'informatique</p>
        </div>
        <div class='container'>
            <a href="https://www.epitech.eu/"><img src="les_photos_drive/logo_epitech.png" alt="logo"></a>
            <p> l’atelier <br>
                Pauline témoigne: <br>
                pourquoi/comment le choix <br> 
                du numérique/programation <br> 
                informatique <br>  
                illustrations concrètes</p>
        </div>
    </div>
    <div>
