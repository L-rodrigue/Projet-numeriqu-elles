...
<div class="stage_picture">
  ...
  <div class="first_paragraph">
    <p>Dans le cadre, d’un projet de recherche InserNum, le corif grâce aux
      ...
      IBM une première Edition Numériqu’ELLES en 2015. Soutenu par l’ETAT DRDFE,
      la Région HDF, le Départements Numériqu’ELLES se démultiplient sur les HDF.</p>
    </div>
    ...
    <div class="second_paragraphe">
      <p>La première édition de Numériqu’Elles est organisée à Lille, et reprise les
        années suivantes en associant de nouveaux partenaires tout en perfectionnant
        l’organisation grâce notamment au questionnaire de satisfaction complété par
        les élèves. Chaque année le CORIF se charge de les dépouiller.
      ...
      <div class="text_for_the_map">
        ...
        <div class="last_subtitle">
          <h2>Pourquoi Numériqu’ELLES</h2>
        </div>

        <div class="last_paragraph">
          <p>Pourquoi les femmes renoncent-elles aux métiers du numérique et de l’informatique ? Les filles
            ...
            pourquoi certaines jeunes filles et femmes hésitent encore à choisir des filières du IT.
            Ce constata permis l’émergence de Numériqu’Elles. Cet évènement a été imaginé pour
            répondre auxbesoins de recruter de nouveaux talents (femmes) pour IBM mais très
            vite d’autres entrepriseset partenaires de nous rejoint. C’est en 2016 que le
            second Numériqu’Elles a vu le jour sousune forme plus collective et en 2018 ce format est dupliqué sur Amiens.</p>
          </div>
